...
Context Speed Sweep Benchmark for Poolside Laguna-S-2.1 NVFP4
Evaluates TTFT, Ingestion Speed (t/s), and Generation/Decode Speed (t/s)
across context windows (512 to 131,072 tokens).
"""
...
CONTEXT_TEST_SIZES = [512, 2048, 4096, 8192, 16384, 32768]
GEN_TOKENS = 128

PAD_TEXT = (
    "The NVIDIA B200 Blackwell architecture with 192GB VRAM provides hardware acceleration "
    "for NVFP4 (4-bit floating point) weights and activations, leveraging tensor cores and FlashInfer attention. "
    "Poolside Laguna-S-2.1 is a ~68B Mixture-of-Experts coding model with 256 experts and 10 active experts per token. "
)
...
def run_speed_sweep(base_url: str, api_key: str, output_json: str):
    ...
    print("=" * 70)
    print(f"LAGUNA-S-2.1 NVFP4 SPEED SWEEP BENCHMARK")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Laguna-S-2.1 NVFP4 Speed Sweep Benchmark")
    ...
    parser.add_argument("--output", type=str, default="devices_and_hardware/b200_laguna_s_21_nvfp4/results/speed_sweep_results.json", help="Path to save output JSON")
