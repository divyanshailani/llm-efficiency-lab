...
Context Speed Sweep Benchmark for Qwopus3.5 122B NVFP4 (W4A4)
...
PAD_TEXT = (
    ...
    "OpenYourMind Qwopus3.5 122B is a 122B Mixture-of-Experts model with 10B active parameters per token, distilled from Kimi K2.6 and Opus 3.5. "
)
...
def run_speed_sweep(base_url: str, api_key: str, output_json: str):
    ...
    print("=" * 70)
    print(f"QWOPUS 3.5 122B NVFP4 SPEED SWEEP BENCHMARK")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Qwopus3.5 122B NVFP4 Speed Sweep Benchmark")
    ...
    parser.add_argument("--output", type=str, default="devices_and_hardware/rtx_pro_6000_qwopus3.5_122b_nvfp4/results/speed_sweep_results.json", help="Path to save output JSON")
