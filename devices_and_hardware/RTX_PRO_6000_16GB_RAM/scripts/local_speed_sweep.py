...
# Adjust this URL to match your local llama-server or vLLM deployment
...
def run_sweep():
    print("=== Rigorous Context Size Sweep (Deckard 40B Q8 on Blackwell 96GB) ===")
    
    print("\n[Waking up container and loading weights to VRAM...]")
    try:
        resp = requests.post(BASE_URL, json={"model": MODEL, "messages": [{"role": "user", "content": "hello"}], "max_tokens": 1}, timeout=600)
    ...
    for size in CONTEXT_SIZES:
        ...
        for iteration in range(3):
            try:
                ...
                for line in resp.iter_lines():
                    if line:
                        ...
                        if decoded.startswith("data: "):
                            ...
                            # llama-server often includes 'usage' in the final streaming chunk
                ...
                # Fallback to approximate if usage was not returned
                approx_warning = ""
                if prompt_tokens == 0:
