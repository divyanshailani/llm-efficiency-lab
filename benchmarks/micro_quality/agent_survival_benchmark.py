...
def run_quality_gates():
    print("=== Starting Strict Agent Survival Benchmark ===\n")
    results = {}
    passed = 0
    total = 0
    ...
    content = msg.get("content", "").strip() if msg else ""
    ...
    results = {
        ...
        "tests": {
            ...
            "state_tracking": passed >= 3, # Simplification for json dump
    ...
    print("Results saved to survival_results.json")
    if passed == total:
